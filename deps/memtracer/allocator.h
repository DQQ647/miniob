...
extern "C" mt_visible void    *pvalloc(size_t size) throw();
...
extern "C" mt_visible void *__libc_valloc(size_t size) throw() __attribute__((alias("valloc"), used));
extern "C" mt_visible void *__libc_pvalloc(size_t size) throw() __attribute__((alias("pvalloc"), used));
extern "C" mt_visible void *__libc_memalign(size_t alignment, size_t size) __attribute__((alias("memalign"), used));
extern "C" mt_visible int   __posix_memalign(void **memptr, size_t alignment, size_t size) throw()
